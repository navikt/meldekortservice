...
internal const val LESEMODUS_PATH = "$API_PATH/lesemodus"

internal const val KONTROLL_KONTROLL = "/api/v1/kontroll"

internal const val ARENA_ORDS_API_V1_APP = "/api/v1/app"
internal const val ARENA_ORDS_HENT_LESEMODUS = "$ARENA_ORDS_API_V1_APP/lesemodus"
internal const val ARENA_ORDS_API_V1_MELDEPLIKT = "/api/v1/meldeplikt"
internal const val ARENA_ORDS_TOKEN_PATH = "/api/oauth/token"
internal const val ARENA_ORDS_HENT_MELDEKORT = "$ARENA_ORDS_API_V1_MELDEPLIKT/meldekort?fnr="
internal const val ARENA_ORDS_HENT_HISTORISKE_MELDEKORT = "$ARENA_ORDS_API_V1_MELDEPLIKT/meldekort/historiske?fnr="
internal const val ARENA_ORDS_MELDEPERIODER_PARAM = "&antMeldeperioder="
internal const val ARENA_ORDS_HENT_MELDEKORTDETALJER = "$ARENA_ORDS_API_V1_MELDEPLIKT/meldekort/detaljer?meldekortId="
internal const val ARENA_ORDS_KOPIER_MELDEKORT = "$ARENA_ORDS_API_V1_MELDEPLIKT/meldekort/kopi"

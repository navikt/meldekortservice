...
class MeldekortdetaljerMapperTest {
    ...
    fun testMeldekortdetaljerMapper() {
        ...
        var svarJa = Svar(BooleanVerdi(true), BooleanVerdi(false))
        var svarNei = Svar(BooleanVerdi(false), BooleanVerdi(true))
        var spm = ArenaSpm(
            svarJa,
            svarJa,
            svarNei,
        ...
        var fra = ArenaMeldekort(hode, spm)
        var til: Meldekortdetaljer = MeldekortdetaljerMapper.mapOrdsMeldekortTilMeldekortdetaljer(fra)

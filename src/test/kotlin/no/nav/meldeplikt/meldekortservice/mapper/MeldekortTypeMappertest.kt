...
class MeldekortTypeMappertest {
    ...
    fun testMeldekortTypeMapper() {
        ...
        val fra = Meldekortdetaljer("33", 150L, "999444", 7655687, "202013", "Skelly", KortType.ORDINAER,             LocalDate.parse("2020-01-20", DateTimeFormatter.ISO_DATE),
            LocalDate.parse("2020-01-21", DateTimeFormatter.ISO_DATE),sporsmal, "Grunngitt")

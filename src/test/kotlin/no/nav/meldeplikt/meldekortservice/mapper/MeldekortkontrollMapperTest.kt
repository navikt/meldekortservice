...
class MeldekortkontrollMapperTest {
    ...
    fun testMeldekortkontrollMapper() {
        ...
        sammenlignMeldekortDag(meldekortkontroll.fravaersdager[0], meldekortDager[0], meldekortkontroll.periode_fra!!)
        assert(meldekortkontroll.fravaersdager[0].harSyk!!)
        sammenlignMeldekortDag(meldekortkontroll.fravaersdager[1], meldekortDager[1], meldekortkontroll.periode_fra!!)
